...
<?php
    foreach ($creatives as $creative) {
      echo "<tr><td><a href='?page=mt_creative&creativeId=" . $creative->id . "'>" . $creative->id ."</a></td><td><a href='?page=mt_creative&creativeId=" . $creative->id . "'>" . $creative->title ."</a></td><td></td></tr>";
    }
?>
</table>
</div>
