...
<?php
  ...
  $table = new campaign_stats_per_day_table();
...
<h2>Per country</h2>
<?php
  $table = new campaign_stats_per_country_table();
...
class campaign_stats_per_country_table extends campaign_stats_per_day_table {
...
class campaign_stats_per_day_table extends WP_List_Table {
